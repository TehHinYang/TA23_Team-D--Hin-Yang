...
def cash_on_hand_function():
  """
  - This function reads the cash on hand values in the csv files and calculates the differences for each days. 
  - It then determines whether it is a surplus of deflict
  """
